...
public class TestShardingSphere {
    ...
    public static final String SQL_TEMPLATE = "CREATE TABLE t_user_%d ( \n" +
            ...
            "  username VARCHAR(25) CHARACTER SET utf8mb4 NULL COMMENT '用户名', \n" +
            "  password VARCHAR(51) CHARACTER SET utf8mb4 NULL COMMENT '密码', \n" +
            "  real_name VARCHAR(25) CHARACTER SET utf8mb4 NULL COMMENT '真实姓名', \n" +
            "  phone VARCHAR(12) CHARACTER SET utf8mb4 NULL COMMENT '手机号', \n" +
            "  mail VARCHAR(51) CHARACTER SET utf8mb4 NULL COMMENT '邮件', \n" +
